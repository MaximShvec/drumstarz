...
export function TrainersPage() {
  ...
  useDocumentMeta(
    "Преподаватели — DRUMSTARZ школа барабанов в Риге",
    ...
    <>
      ...
      <section className="bg-paper py-24 text-ink lg:py-32" aria-labelledby="trainers-intro-title">
        <div className="container-site grid items-center gap-12 lg:grid-cols-2">
          <Reveal>
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-mint-dim">Сердце DRUMSTARZ</p>
            <h2
          ...
          <Reveal delay={80}>
            <img
              ...
              alt="Преподаватель DRUMSTARZ за барабанной установкой"
