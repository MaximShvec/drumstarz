  ...
  return (
    <section id="prices" className="bg-void py-24 lg:py-32" aria-labelledby="pricing-title">
      <div className="container-site">
        <Reveal>
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-mint">Тарифы</p>
          <h2 id="pricing-title" className="mt-3 font-display text-4xl font-extrabold tracking-[-0.03em] sm:text-5xl">
            Курсы и цены школы барабанов
          </h2>
          <p className="mt-3 text-cream/60">
            Детям от 10 лет и взрослым <span className="text-mint">любого</span> возраста
          </p>
        </Reveal>
        ...
        <Reveal className="mt-10">
          <div className="relative overflow-hidden rounded-[1.8rem] border border-mint/25 bg-panel">
            <img
              src="/assets/img/section4/trial-banner.jpg"
              alt=""
            ...
            <div className="relative flex flex-col gap-6 p-8 md:flex-row md:items-center md:justify-between md:p-10">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h3 className="font-display text-2xl font-semibold">Первое пробное занятие</h3>
                  <p className="text-cream/60">
                    Длительность <span className="text-cream">30 минут</span>
                  </p>
                </div>
              </div>
            ...
            >
                <div className="relative h-52">
                  ...
                  <div className="absolute bottom-4 left-5">
                    ...
                    <p className="text-sm text-cream/55">{card.kind}</p>
                  </div>
                </div>
                <div className="flex flex-1 flex-col p-6">
                  ...
                  <p className="mt-5 text-xs uppercase tracking-[0.16em] text-cream/40">Цена за одно занятие</p>
                  <p className="font-display text-3xl font-semibold">{card.unit}</p>
                  <p className="mt-2 text-sm text-cream/55">{card.note}</p>
                  <div className="mt-auto pt-6">
                    <p className="mb-4 text-sm text-cream/50">
                      <strong className="text-xl text-cream">{card.total}</strong> цена абонемента
                    </p>
                    <Button
